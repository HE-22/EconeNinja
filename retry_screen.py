...
class RetryScreen:
    def __init__(self, screen):
        ...
        self.game_over_sound = pygame.mixer.Sound(
            "/Users/hassen/local_Dev/GAMES/sample_pygame/assets/audio/demon_game_over.mp3"
        )

        # Load the main music as a Sound object
        self.game_over_music = pygame.mixer.Sound(
            "/Users/hassen/local_Dev/GAMES/sample_pygame/assets/audio/game_over_music.ogg"
        )
