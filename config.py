...
FAST_WHOOOSH_SOUND_PATH = (
    "/Users/hassen/local_Dev/GAMES/sample_pygame/assets/audio/sfx/fast_whoosh.mp3"
)
...
COIN_SPAWN_MARGIN = 120  # How far away from the edge of the screen coins can spawn
